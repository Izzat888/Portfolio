...
const Footer = ({ darkMode }) => {
  ...
  return (
    ...
    style={{
        background: darkMode 
        ? 'linear-gradient(to bootom, #000000, #111827)' 
        : 'linear-gradient(to bootom, #f3f4f6, #e5e7eb)',
        ...
        <div className="container mx-auto px-4 py-8">
            ...
            items-center gap-6">
                ...
                <div className="flex gap-4">
                    ...
                    hover:bg-linear-to-r hover:bg-orange-500
                    hover:to-amber-500 hover:text-white bg-[#374151] dark:bg-[#f3f4f6]
