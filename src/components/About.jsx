        ...
        gap-8 sm:gap-12 items-center">
            ...
            order-2 lg:order-1">
                    <div className="relative w-75 h-75 lg:w-96 lg:h-96">
                        {/* Image */}
                        <div className="absolute -inset-4 lg:-inset-20 bg-linear-to-l
                    from-[#f97316] via-[#fb923c] to-[#f59e0b] rotate-12
                    star-shape z-0"
                            data-aos='zoom-in'
                            data-aos-delay='600'>
                        </div>
                        <img
                            src={about}
                            alt="About Image"
                            className='absolute about w-270 h-160 object-cover -top-35
                    z-10 transition-all duration-300 rounded-b-full'
                            data-aos='zoom-in'
                            data-aos-delay='400' />
                    </div>
                </figure>
                <article
                    ...
                    xl:text-6xl font-bold mb-4 sm:mb-6 text-transparent bg-linear-to-r
                    ...
                    from-orange-900/10 to-orange-900/5 p-4 sm:p-6 rounded-xl sm:rounded-2xl
